            ...
            <section className="py-24 bg-gaming-900 border-t border-gaming-800 relative z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-end mb-12">
                        <div>
                            <h2 className="text-3xl md:text-4xl font-heading font-bold text-white">{t['home_featured']}</h2>
                        </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {loadingFeatured ? (
                            <div className="text-gray-400 p-8 w-full text-center col-span-full">{t['home_loading_featured']}</div>
                        ) : featuredAccounts.length === 0 ? (
                            <div className="text-gray-400 p-8 w-full text-center col-span-full">{t['home_no_featured']}</div>
                        ) : (
            ...
            <section className="py-24 bg-gaming-900 border-t border-gaming-800 relative z-10">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        >
                            {t['feat_title']} <span className="text-gaming-accent">{t['feat_title_highlight']}</span>
                        </motion.h2>
                        <motion.p
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
