            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    ...
                    <h1 className="text-4xl md:text-5xl font-heading font-extrabold text-white mb-4 tracking-tight">
                        {t['trusted_title_1']}<span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">{t['trusted_title_2']}</span>
                    </h1>
                                ...
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <div className="w-full grid grid-cols-2 gap-3 mt-auto">
                                        ...
                                        >
                                            ...
                                            <span className="text-xs text-blue-400 font-bold uppercase">{t['trusted_btn_fb']}</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                {!loading && admins.length === 0 && (
                    <div className="text-center py-20 border-2 border-dashed border-gaming-700 rounded-2xl max-w-2xl mx-auto">
                        ...
                        <h3 className="text-xl font-bold text-white mb-2">{t['trusted_no_admins']}</h3>
                        <p className="text-gaming-muted">{t['trusted_no_admins_desc']}</p>
                    </div>
                )}
