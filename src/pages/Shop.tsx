            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="pb-4 pt-4 -mx-4 px-4 sm:mx-0 sm:px-0 mb-8 max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <div>
                            <h1 className="text-4xl font-heading font-extrabold text-white mb-2">Account <span className="text-gaming-accent">Shop</span></h1>
                            <p className="text-gaming-muted">Find your dream Free Fire account today.</p>
                        </div>
                    ...
                    >
                        <div>
                            ...
                            <select value={priceRange} onChange={(e) => setPriceRange(e.target.value)} className="glass-input">
                                <option value="All" className="bg-gaming-900">All Prices</option>
                                <option value="Under 500" className="bg-gaming-900">Under 500 BDT</option>
                                <option value="500-1500" className="bg-gaming-900">500 - 1500 BDT</option>
                                <option value="1500-3000" className="bg-gaming-900">1500 - 3000 BDT</option>
                                <option value="Over 3000" className="bg-gaming-900">Over 3000 BDT</option>
                            </select>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-300 mb-2">Minimum Level</label>
                            <select value={minLevel} onChange={(e) => setMinLevel(e.target.value)} className="glass-input">
                                <option value="Any" className="bg-gaming-900">Any Level</option>
                                <option value="60+" className="bg-gaming-900">Level 60+</option>
                                <option value="70+" className="bg-gaming-900">Level 70+</option>
                                <option value="80+" className="bg-gaming-900">Level 80+</option>
                            </select>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-300 mb-2">Max Evos</label>
                            <select value={minEvos} onChange={(e) => setMinEvos(e.target.value)} className="glass-input">
                                <option value="Any" className="bg-gaming-900">Any</option>
                                <option value="1+" className="bg-gaming-900">1+ Max Evo</option>
                                <option value="3+" className="bg-gaming-900">3+ Max Evos</option>
                                <option value="5+" className="bg-gaming-900">5+ Max Evos</option>
                            </select>
                        </div>
                        <div className="flex items-end">
                            <button onClick={() => setShowFilters(false)} className="btn-primary w-full py-2.5 justify-center">Done</button>
                        </div>
                    </motion.div>
                )}
                ...
                <div className="mb-6 flex items-center justify-between text-sm text-gaming-muted">
                    <p>Showing <span className="text-white font-bold">{filteredAndSortedAccounts.length}</span> results</p>
                    <div className="flex items-center gap-2 relative">
                        ...
                        >
                            <option value="Featured" className="bg-gaming-800">Featured</option>
                            <option value="Newest" className="bg-gaming-800">Newest</option>
                            <option value="Price: Low to High" className="bg-gaming-800">Price: Low to High</option>
                            <option value="Price: High to Low" className="bg-gaming-800">Price: High to Low</option>
                        </select>
                    </div>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20 bg-gaming-800/50 rounded-2xl border border-gaming-700">
                        ...
                        <h3 className="text-2xl font-heading font-bold text-white mb-2">No accounts found</h3>
                        <p className="text-gaming-muted">Try adjusting your search or filters to find what you're looking for.</p>
                    </div>
                )}
