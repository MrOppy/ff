            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-gaming-800 border border-gaming-700 rounded-2xl p-8 md:p-12 text-center shadow-lg relative overflow-hidden">
                    ...
                    <h1 className="text-3xl font-heading font-bold text-white mb-4">
                        Contact <span className="text-gaming-accent">Support</span>
                    </h1>

                    <p className="text-xl text-gaming-muted max-w-xl mx-auto mb-10 leading-relaxed">
                        For the fastest response regarding buying, selling, or middleman services for Free Fire accounts, reach out to me directly on my social channels!
                    </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        >
                            ...
                            <div className="text-left">
                                <p className="text-sm text-emerald-400 font-bold mb-1 uppercase tracking-wide">WhatsApp</p>
                        ...
                        >
                            ...
                            <div className="text-left">
                                <p className="text-sm text-blue-400 font-bold mb-1 uppercase tracking-wide">Facebook</p>
                        ...
                        >
                            ...
                            <div className="text-left">
                                <p className="text-sm text-pink-400 font-bold mb-1 uppercase tracking-wide">Instagram</p>
                        ...
                        >
                            ...
                            <div className="text-left">
                                <p className="text-sm text-red-400 font-bold mb-1 uppercase tracking-wide">YouTube</p>
