    ...
    return (
        <div className="pt-24 pb-16 min-h-screen">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="mb-8">
                    <h1 className="text-4xl font-heading font-extrabold text-white mb-2">Sell <span className="text-gaming-accent">Account</span></h1>
                    <p className="text-gaming-muted">List your Free Fire account for sale safely and securely.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    {/* Media Links */}
                    <div className="bg-gaming-800/50 p-6 rounded-2xl border border-gaming-700">
                        <h2 className="text-xl font-bold text-white mb-2 border-b border-gaming-700 pb-2">Images</h2>
                        <p className="text-sm text-gaming-muted mb-4">
                            Since we are running in a lightweight setup, upload your images to <a href="https://catbox.moe" target="_blank" className="text-gaming-accent underline">Catbox.moe</a> and paste the direct image links here. The first link will be used as the main thumbnail!
                        </p>
                        ...
                        <div className="flex gap-2 mb-6">
                            <div className="relative flex-grow">
                                <Upload className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gaming-muted" />
                                <input
                            ...
                            <button type="button" onClick={addImage} className="btn-secondary px-6">Add Link</button>
                        </div>
