                                        ...
                                        {filteredUsers.map(u => (
                                            <tr key={u.id} className="hover:bg-gaming-700/30 transition-colors">
                                                <td className="px-6 py-4 flex items-center gap-3">
                                                    {u.photoURL ? <img src={u.photoURL} alt="" referrerPolicy="no-referrer" className="w-8 h-8 rounded-full" /> : <div className="w-8 h-8 bg-gaming-700 rounded-full" />}
                                                ...
                                                <td className="px-6 py-4 text-right">
                                                    <div className="flex justify-end gap-2 flex-wrap">
                                                        {u.displayName && (
                                                            <button
                                                                onClick={() => window.open(`/seller/${encodeURIComponent(u.displayName)}`, '_blank')}
                                    ...
                                    <details key={u.id} className="group outline-none">
                                        <summary className="p-4 flex items-center justify-between cursor-pointer list-none hover:bg-gaming-800 transition-colors">
                                            <div className="flex items-center gap-3">
                                                {u.photoURL ? <img src={u.photoURL} alt="" referrerPolicy="no-referrer" className="w-10 h-10 rounded-full object-cover" /> : <div className="w-10 h-10 bg-gaming-700 rounded-full" />}
                                                <div>
