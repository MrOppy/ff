                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <p className="text-gaming-muted text-sm leading-relaxed mb-6">
                            The biggest marketplace of Bangladesh to buy and sell Free Fire accounts safely. Verified sellers, instant connections, epic accounts.
                        </p>
                    ...
                    {/* Quick Links */}
                    <div>
                        <h3 className="text-white font-heading font-bold text-lg mb-4 uppercase tracking-wide">Quick Links</h3>
                        <ul className="space-y-3">
                            <li><Link to="/shop" className="text-gaming-muted hover:text-gaming-accent transition-colors text-sm">Shop Accounts</Link></li>
                            <li><Link to="/trusted-admins" className="text-gaming-muted hover:text-gaming-accent transition-colors text-sm">Trusted Admins</Link></li>
                            <li><Link to="/about" className="text-gaming-muted hover:text-gaming-accent transition-colors text-sm">About Us</Link></li>
                            <li><Link to="/contact" className="text-gaming-muted hover:text-gaming-accent transition-colors text-sm">Contact Support</Link></li>
                        </ul>
                    </div>

                    {/* Legal */}
                    <div>
                        <h3 className="text-white font-heading font-bold text-lg mb-4 uppercase tracking-wide">Legal</h3>
                        <ul className="space-y-3">
                            <li><Link to="/terms" className="text-gaming-muted hover:text-gaming-accent transition-colors text-sm">Terms of Service</Link></li>
                            <li><Link to="/privacy" className="text-gaming-muted hover:text-gaming-accent transition-colors text-sm">Privacy Policy</Link></li>
                            <li><Link to="/refund" className="text-gaming-muted hover:text-gaming-accent transition-colors text-sm">Refund Policy</Link></li>
                            <li><Link to="/middleman-rules" className="text-gaming-muted hover:text-gaming-accent transition-colors text-sm">Middleman Rules</Link></li>
                        </ul>
                    </div>
